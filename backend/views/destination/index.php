...
/* @var $searchModel backend\models\DestinationSearch */
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=destination/view&id=' . $model->id_destination;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=destination/update&id=' . $model->id_destination;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=destination/delete&id=' . $model->id_destination;
                        return $url;
                    }
                }
            ],
